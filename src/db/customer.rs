...
pub async fn find_customer_by_id(
    ...
    let customer_json = Customer {
        ...
        firstName: unwrapped_doc.firstName.to_string(),
        lastName: unwrapped_doc.lastName.to_owned(),
...
pub async fn insert_customer(
    ...
    let insert_one_result = collection
        .insert_one(
            doc! {"firstName": input.firstName.clone(), "lastName": input.lastName.clone(), "createdAt": created_at},
            None,
        )
        .await?;
